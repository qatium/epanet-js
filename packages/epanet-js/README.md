...
You will need a Github Token of yours with scope "write:packages" exported as the environment variable GITHUB_PUBLISH_PACKAGES_TOKEN. (`export GITHUB_PUBLISH_PACKAGES_TOKEN="xyz"`)
